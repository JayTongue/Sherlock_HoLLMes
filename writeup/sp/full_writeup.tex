...
\hypersetup{
  ...
  pdfauthor={{[}AUTHOR INFO{]}},
  hidelinks,
  pdfcreator={LaTeX via pandoc}}

\title{Retrieval Capabilities of Legal AI Tools}
\author{{[}AUTHOR INFO{]}\footnote{{[}AUTHOR INFO{]}}}
\date{2026}
